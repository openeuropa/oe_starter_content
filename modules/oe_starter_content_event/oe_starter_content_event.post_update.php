...
/**
 * Add Online location field.
 */
function oe_starter_content_event_post_update_00002(&$sandbox) {
  $storage = new FileStorage(drupal_get_path('module', 'oe_starter_content_event') . '/config/post_updates/00002_new_online_location_field');
  \Drupal::service('config.installer')->installOptionalConfig($storage);
